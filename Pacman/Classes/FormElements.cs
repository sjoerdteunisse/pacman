...
namespace Pacman
{
    public class FormElements
    {
        ...
        public Label StepsTaken = new Label();
        ...
        public void CreateFormElements(Form formInstance)
        {
            ...
            StepsTaken.ForeColor = System.Drawing.Color.White;
            StepsTaken.Font = new System.Drawing.Font("Folio XBd BT", 14);
            StepsTaken.Text = "0";
            StepsTaken.Top = 23;
            StepsTaken.Left = 280;
            StepsTaken.Height = 20;
            StepsTaken.Width = 200;
            formInstance.Controls.Add(StepsTaken);
            StepsTaken.BringToFront();
